        ...
        <UserContext.Provider value={{ userInfo, setUserInfo }}>
          <Layout style={{ minHeight: "100vh" }}>
            <Sider
              collapsible
              collapsed={collapsed}
              onCollapse={onCollapse.bind(undefined, collapsed)}
            >
              <div>
                <div className="logo-container">
                  <div className="logo">
                    <img
                      className="logo-img"
                      src="https://weare1909.org/wp-content/uploads/2020/04/1909-logo@2x.png"
                    />
                  </div>
                </div>
                <Menu mode="inline">
              ...
              <Content style={{ padding: "24px 50px" }}>
                <div>
                  <Switch>
                    ...
                    <Route path="/users">{authUser && <Users />}</Route>
